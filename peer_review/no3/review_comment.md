...
- Most of [17]-[26] proposes the collaborative scheduling problem between production and transportation. 私は問題定式化で新しいアイディアを加えた様子がないと判断した。
- WHOとPSOのハイブリッドは存在する。特にスケジューリングのためのものもすでに提案されており、全く新しいアイディアではない。
...
[21]: Babor, M., Paquet-Durand, O., Kohlus, R. et al.: "Modeling and optimization of bakery production scheduling to minimize makespan and oven idle time", Sci Rep Vol. 13, No. 235 (2023). (https://doi.org/10.1038/s41598-022-26866-9)
